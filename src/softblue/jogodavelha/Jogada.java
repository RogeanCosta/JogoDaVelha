...
public class Jogada {
	...
	private void parseString(String jogada) throws JogadaInvalidaException {
		try {
			// Separa em dois tokens, onde o delimitador é a vírgula
			...
			throw new JogadaInvalidaException("A jogada é invalida");
		}
	}
