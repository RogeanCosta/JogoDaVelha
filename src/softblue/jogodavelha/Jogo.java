...
public class Jogo {
	...
	/**
	 * Lista com os dois jogadores que irão jogar
	 */
	private List<Jogador> jogadores= new ArrayList<>();

	/**
	 * Gerenciado de pontuação
	 */
	...
	/**
	 * Inicia o jogo
	 * @throws JogoDaVelhaException Lançada de ocorrer algum problema durante o andamento do jogo
	 */
	public void jogar() throws JogoDaVelhaException {
		...
		// Se o jogador informado já tiver alguma pontuação gravada no arquivo, mostrará o número de vitórias
