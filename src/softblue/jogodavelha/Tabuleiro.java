...
public class Tabuleiro {
	...
	/**
	 * Zerar os elementos da matriz significar colocar um espaço em branco em cada posição
	 */
	public void zerar() {
	...
	/**
	 * Verifica se ainda exsitem posições no tabuleiro onde ainda não houve jogada
